...
D10-A / Accepted D-035 merged in PR #31. This review branch implements the
[synthetic Discovery brief and descriptive review](../../docs/guides/synthetic-discovery.md)
in the same intake interface, including stale-answer history and cross-tab recovery.
