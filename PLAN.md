...
[D12-A / Accepted D-037](docs/architecture/d12-bounded-preparation-worker.md) now specifies one zero-model preparation worker and minimum proof/correction capture. The owner approved `7ac9f9db` on 2026-09-08; it remains design only until D12-B. No worker execution, consequential-rule activation, real data, release or deployment.
...
6. **D12-A — design Accepted, no implementation:** [D-037](docs/architecture/d12-bounded-preparation-worker.md)
   ...
   after normal design merge: explicit template/pack v2, fixed zero-model worker/profile, one supporting
...
is authorized by Accepted D-037 but not implemented; D13 comparisons include failed/open work and all attributable
