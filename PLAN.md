...
| 2 — Case and event engine      | Deterministic state machine, event journal, idempotent create/merge, audit lineage                        | Transition, duplicate-event, and immutable-journal tests pass         |
...
| 4 — Local appliance            | API, worker, PostgreSQL migrations, fixture loader, `fr init ecc --demo`, and `fr up`                     | Fresh-machine local demo starts from documented commands              |
