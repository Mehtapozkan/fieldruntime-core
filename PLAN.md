...
This branch adds **D11-A design only**: [Accepted D-036](docs/architecture/d11-reviewed-runtime-pack.md)
and a populated preparation-pack example. D11-B publication and D12 worker integration
remain unimplemented. No model/worker, real-data activation, release or deployment is included.
...
| D11 — Reviewed Runtime Builder                                 | Approved design | D11-A specifies one preparation-only pack and publication boundary (D-036); D11-B authorized; awaits PR #33 merge                                                                          | Reproducible pack; draft/contradictory rules cannot execute; approved diffs and rollback; any changed trust/closure boundary has human approval                                   |
...
5. **D11-A — accepted design, PR #33 pending merge:** [Accepted D-036](docs/architecture/d11-reviewed-runtime-pack.md)
   ...
   D11-B implements one pack review/publication path after normal PR #33 merge; no worker
