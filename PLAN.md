...
`7ac9f9db` and the owner approval at `0812e004` after required CI. D12-B is implemented
on this review branch: one fixed zero-model preparation worker and separate task,
...
6. **D12-A merged; D12-B implemented for review:** explicit worker-capable pack v2,
   ...
   available. Review the implementation and operator usefulness before advancing.
   D13 is the next planned customer comparison/Capacity Map; real-data activation
...
is implemented for review under Accepted D-037; D13 comparisons include failed/open work and all attributable
