...
This branch adds **D11-A design only**: [Proposed D-036](docs/architecture/d11-reviewed-runtime-pack.md)
...
| D11 — Reviewed Runtime Builder                                 | Design review | D11-A proposes one preparation-only pack and publication boundary (D-036); D11-B implementation awaits approval                                                                            | Reproducible pack; draft/contradictory rules cannot execute; approved diffs and rollback; any changed trust/closure boundary has human approval                                   |
