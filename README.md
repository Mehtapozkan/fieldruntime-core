...
D-040. The [evaluation-readiness handoff](docs/guides/investigation-evaluation-readiness.md)
preserves the 24-case deterministic baseline and frozen comparison. A separate
versioned credential/tokenizer/live-attribution connection is tested with mocked HTTP
only. The owner conditionally approved 48 model-arm calls and USD 0.96; actual
project, custody, storage and complete input-accounting confirmations still block
activation. Deterministic preparation remains the appliance default. No live model
comparison or human scoring has run; customer processing remains unapproved.
...
| Imported no-adjustment dispute result                     | Explicit enrollment, proof/review/report/check and separate acceptance/reopen                                   | Fixed synthetic proof reader, exact D6 authority, independent result, separate recipient acceptance and reopening                  | API: PR #41; Workbench: PR #42 (both open)                                                      |
| Optional scoped investigation                             | No activation control; deterministic preparation stays default                                                  | Versioned fake-provider proposal, durable call/budget reservations and exact response replay; human interpretation review required | PR #43/#44 stacked on #42; conditional activation prerequisites pending, model comparison unrun |
...
Production authentication, real connectors, generally available live providers, general workers,
